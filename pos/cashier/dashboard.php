              ...
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-auto">
                      <div class="icon icon-shape text-white rounded-circle shadow d-flex align-items-center justify-content-center" style="width: 50px; height: 50px; font-size: 24px; background-color: green;">
                        Rp
                      </div>
                    </div>
                  </div>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="orders_reports.php" class="btn btn-sm btn-primary">Lihat semua</a>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th class="text-success" scope="col"><b>Produk</b></th>
                ...
                <tbody>
                  ...
                  while ($order = $res->fetch_object()) {
                    ...
                    <tr>
                      ...
                      <td class="text-success" style="text-align: center;"><?php echo $order->prod_qty; ?></td>
                      <!-- Jumlah diposisikan ke tengah -->
        ...
        <div class="col-xl-12">
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Pembayaran Terkini</h3>
                </div>
                <div class="col text-right">
                  <a href="payments_reports.php" class="btn btn-sm btn-primary">Lihat semua</a>
                </div>
              </div>
            </div>
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th class='text-success' scope="col"><b>Kode Pemesanan</b></th>
                  </tr>
                </thead>
                <tbody>
                  <?php
